...
class MainActivity : AppCompatActivity(), ChangeRestTimeDialog.Callback, ChangePlaceDialog.Callback,
    ...
    override fun onStart() {
        ...
        val animPressed = AnimationUtils.loadAnimation(this, R.anim.anim_button_pressing)// STOPSHIP: 22.01.2022 delete anims
        ...
        binding.pauseResumeButton.setOnTouchListener { view, motionEvent ->
            when (motionEvent.action) {
                MotionEvent.ACTION_DOWN -> view.startAnimation(AnimationUtils.loadAnimation(this, android.R.anim.fade_out))
//                MotionEvent.ACTION_DOWN -> view.startAnimation(animPressed)
                MotionEvent.ACTION_UP   -> view.startAnimation(AnimationUtils.loadAnimation(this, android.R.anim.fade_in))
